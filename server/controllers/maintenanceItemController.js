...
const maintenanceItemController = {
  getItemsList: (req, res, next) => {
    ...
    const text =
      'SELECT * FROM maintenance_details WHERE user_id = $1';
  ...
  addItem: (req, res, next) => {
    ...
    const values = [item_name, model, warranty, resources, vendor_name, vendor_phone, last_service_date, next_service_date, frequency, user_id];
    db.query(text, values)
      .then((response) => {
  ...
  updateItemDetails: (req, res, next) => {
    ...
    const values = [item_name, model, warranty, resources, vendor_name, vendor_phone,last_service_date, next_service_date, frequency, maintenance_details_id];
    db.query(text, values)
      .then((response) => {
